...
if (filter_has_var(INPUT_POST, 'modificar')) {
    ...
    $nombreCortoValido = filter_var($nombreCorto, FILTER_VALIDATE_REGEXP,
                ...
                <form method="POST" action="<?= "{$_SERVER['PHP_SELF']}" ?>">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= (isset($nombreValido) ? ($nombreValido ? "is-valid" : "is-invalid") : "") ?>" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= (isset($errorDuplicadoNombreCorto) ? "is-invalid" : (isset($nombreCortoValido) ? ($nombreCortoValido ? "is-valid" : "is-invalid") : "")) ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= (isset($pvpValido) ? ($pvpValido ? "is-valid" : "is-invalid") : "") ?>"
